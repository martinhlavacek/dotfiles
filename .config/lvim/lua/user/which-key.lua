...
wk.mappings["n"] = {
  name = ' ' .. kind.cmp_kind.Constructor .. 'My commands',
  q = { ":MyClose<cr>", kind.icons.exit .. " Quit" },
  l = { "<Plug>Yssurround\'", kind.icons.exit .. " Surround line" },
  w = { "<Plug>Csurround", kind.symbols_outline.TypeParameter .. " Surround word" },
}
...
wk.mappings["s"]["n"] = { ":ObsidianSearch<cr>", kind.icons.docs .. " Search notes" }
...
wk.mappings["W"] = {
  ...
  n = { ":lua require('nvim-navbuddy').open()<cr>", "Navbuddy" }
}
...
wk.mappings["v"] = {
  name = " " .. kind.icons.buffer .. "Copy manager",
  v = { ':Telescope neoclip<cr>', 'Neoclip' },
}
